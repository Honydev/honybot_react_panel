    ...
    return <footer id='page-footer' className='content-mini content-mini-full font-s12 bg-gray-lighter clearfix'>
      <div className='row'>
        <div className='col-sm-6 col-xs-12'>
          <i className='fa fa-twitter' aria-hidden='true' /><a className='font-w600' href='https://www.twitter.com/Honybot'>Honybot</a> - A Twitchbot by <a className='font-w600' href='https://www.twitter.com/HollySC2'>Holly</a>
        </div>
        <div className='col-sm-6 col-xs-12'>
