    ...
    return <React.Fragment>
      ...
      <Block header={'MMR PROGRESSION OVERLAY'} secondary='only works with a valid sc2 profile' dark loading={this.props.loading}>
        <div className='block-content'>
          <img className='img-responsive' style={{'maxWidth': '200px'}} src='http://images.honybot.com/sc/mmr-overlay.jpg' alt='' />
          <h4><a href={'https://www.honybot.com/mmr/' + this.state['sc2-token']}>{'https://www.honybot.com/mmr/' + this.state['sc2-token']}</a></h4>
      ...
      <div className='block'>
        ...
        <div className='block-content'>
          <img className='img-responsive' src='http://images.honybot.com/helper.jpg' style={{'maxWidth': '425px'}} alt='' />
        </div>
        ...
        <div className='block-content'>
          <p>
            <a href='http://downloads.honybot.com/HonyHelper0.4.2.zip' className='btn btn-primary'>Download</a>
          </p>
        </div>
      </div>
    </React.Fragment>
