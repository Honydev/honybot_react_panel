...
class PlannedFeaturesPage extends Component {
  render () {
    ...
    let secondary = <span>&nbsp;- submit your idea via twitter <a href='https://www.twitter.com/Honybot'> @Honybot</a> or <a href='https://www.twitter.com/HollySC2'> @HollySC2</a></span>
      ...
      <div className='pull-r-l'>
        <table className='table table-hover table-vcenter' style={{marginBottom: 0}}>
          ...
          <tr>
            ...
            <td>
              <span className='font-w600' data-toggle='modal'>
                  List all available commands on honybot.com/streamers/name
              </span>
            </td>
          ...
          <tr>
            ...
            <td>
              <span className='font-w600' data-toggle='modal'>
                  Let users bet on honybot.com directly, in addition (or alternatively) to chat
              </span>
            </td>
            <td className='hidden-xs hidden-sm hidden-md text-muted' style={{width: 150}}><em>Starcraft 2</em></td>
          </tr>
