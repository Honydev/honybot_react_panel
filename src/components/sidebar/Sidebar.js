        ...
        <div className='sidebar-content'>
          ...
          <div className='side-header side-content bg-white-op'>
            ...
            <a className='h5 text-white' href='/'>
              <img src='https://static.honybot.com/img/icon_64.png' width='32' height='32' alt='' /> <span className='h4 font-w600 sidebar-mini-hide'>Honybot</span>
            </a>
          </div>
          {/* END Side Header */}
          ...
          <div className='side-content'>
            <ul className='nav-main'>
              ...
              */}
              ...
              <li>
                <a target='_blank' href={'/streamers/' + window.honybot.username + '/leaderboard'}>
